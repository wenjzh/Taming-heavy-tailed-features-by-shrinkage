...
def multi(i):
    ...
    for epoch in range(NUM_EPOCHS):
        train(i, epoch, loader=train_loader, mislable_rate=MISLABLE_RATE)
        trainS(i, epoch, loader=train_loader, mislable_rate=MISLABLE_RATE)
...
print(
    'Mislabling Rate: {}, Noise Level: {}, Noise Level: {} '.format(
        MISLABLE_RATE,
        NOISE_TYPE,
        NOISE_LEVEL))
